                    ...
                    {expandedSeed === b.seed && (
                      <tr className="border-t bg-white">
                        <td colSpan={colspan} className="p-2 md:p-3">
                          <div className="inline-grid grid-cols-[repeat(4,2.5rem)] gap-0 rounded-lg border border-blue-100 bg-blue-50 p-1 text-center text-[9px] md:ml-24 md:w-auto md:grid md:grid-cols-4 md:gap-1.5 md:p-1.5 md:text-xs">
                            {b.games.map((game, gameIndex) => (
                              <div key={`${b.seed}-public-game-${gameIndex}`} className="w-10 rounded-none bg-white p-[2px] shadow-sm first:rounded-l-md last:rounded-r-md md:w-auto md:rounded-lg md:p-1.5 md:text-sm">
